...
const { NODE_ENV, API_BASE, SEGMENT_WRITE_KEY, GITHUB_ACCESS_TOKENS, PORT, SENTRY_DSN, CIRCLE_BUILD_NUM, LOGROCKET_APP_ID, ARTICLE_LIST_ENDPOINT } = process.env
...
const articleListEndpoint = ARTICLE_LIST_ENDPOINT || '';
...
const plugins = [
  new webpack.DefinePlugin({
    'process.env': {
      ...
      ARTICLE_LIST_ENDPOINT: JSON.stringify(articleListEndpoint),
    },
  }),
]
